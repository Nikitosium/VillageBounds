...
public class VillageNamingScreen extends Screen {
    private final ItemStack stack;
    private TextFieldWidget nameField;
    private ButtonWidget acceptButton;

    public VillageNamingScreen(ItemStack stack) {
        super(Text.translatable("screen.villagebounds.naming.title"));
        this.stack = stack;
    }
    ...
    protected void init() {
        ...
        this.nameField = new TextFieldWidget(
                ...
                200,
                20,
                Text.translatable("screen.villagebounds.naming.input")
        );
        ...
        this.acceptButton = ButtonWidget.builder(
                Text.translatable("screen.villagebounds.naming.accept"),
                button -> confirm()
        ).dimensions(centerX - 105, centerY + 10, 100, 20).build();

        ButtonWidget cancelButton = ButtonWidget.builder(
                Text.translatable("screen.villagebounds.naming.cancel"),
                button -> this.close()
    ...
    private void confirm() {
        ...
        ClientPlayNetworking.send(VillageBounds.SET_VILLAGE_NAME_ID, buf);
